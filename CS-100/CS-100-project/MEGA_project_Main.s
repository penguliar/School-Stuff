...
_button_initialization
    PUSH { R4-R11, LR } ; stack preserved registers and link register
      SETBITS GPIOBDIR, 0x00         ; MAKE SURE ALL PORTB PINS (PB0-PB7) ARE SET UP FOR INPUT
      CLEARBITS GPIOBDATA_RW, 0x00   ; MAKE SURE ALL PORTB PINS (PB0-PB7) START WITH 0 ON THE INPUT
	  SETBITS GPIOBPUR, 0x01			 ; MAKE SURE PORTB PINS (PB0-PB1) HAVE A WEAK PULLDOWN
